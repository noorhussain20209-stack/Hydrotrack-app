...
import 'package:permission_handler/permission_handler.dart'; // âœ… FIXED: Added import
...
Future<void> main() async {
  ...
  // âœ… FIXED: Request permission with version check
...
// ============================================================
// âœ… FIXED: NOTIFICATION PERMISSION WITH VERSION CHECK
// ============================================================
Future<void> _requestNotificationPermission() async {
  try {
    ...
    print('âš ï¸ Notification permission not available: $e');
  }
}

// ============================================================
// âœ… FIXED: NOTIFICATION INITIALIZATION WITH ERROR HANDLING
// ============================================================
Future<void> _initNotifications() async {
  try {
    ...
    print('âš ï¸ Notification initialization error: $e');
  }
}

// ============================================================
// âœ… FIXED: TIMEZONE INITIALIZATION WITH FALLBACK
// ============================================================
Future<void> _initTimezone() async {
  try {
    ...
    print('âš ï¸ Timezone initialization error, using UTC: $e');
...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  @override
  void dispose() {
    // âœ… FIXED: Properly dispose animation controller
  ...
  Future<void> _finishOnboarding() async {
    try {
      ...
      print('âŒ Onboarding save error: $e');
      if (mounted) {
...
// ============================================================
// âœ… FIXED: HOME SCREEN WITH ALL BUG FIXES
// ============================================================
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  // ============================================================
  // âœ… FIXED: LOAD STATE WITH ERROR HANDLING
  // ============================================================
      ...
      if (savedDate == today) {
        ...
        _drinkLogs = logsJson.map((json) {
          try {
            ...
            print('âš ï¸ Error parsing log: $e');
            return null;
          }
  ...
  // ============================================================
  // âœ… FIXED: STREAK CALCULATION WITH GOAL CHECK
  // ============================================================
  Future<void> _computeStreak(SharedPreferences prefs) async {
    try {
      ...
      for (int i = 0; i < 365; i++) {
        ...
        // âœ… FIXED: Check if goal is valid
      ...
      print('âš ï¸ Streak calculation error: $e');
    }
  }
  ...
  // ============================================================
  // âœ… FIXED: SAVE STATE WITH ERROR HANDLING
  // ============================================================
  ...
  Future<void> _skipImminentReminder() async {
    ...
    try {
      ...
      print('âš ï¸ Skip reminder error: $e');
    }
  }
  ...
  // ============================================================
  // âœ… FIXED: SCHEDULE REMINDERS WITH PERMISSION CHECK
  // ============================================================
  Future<void> _scheduleReminders({bool silent = false, int adaptiveSkipMinutes = 0}) async {
    try {
      ...
      if (!await Permission.notification.isGranted) {
        ...
        if (!status.isGranted) {
          if (mounted) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('âš ï¸ Please grant notification permission in settings'),
              ),
            );
          }
          return;
      ...
      print('âŒ Schedule reminders error: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  Future<void> _cancelReminders() async {
    try {
      ...
      print('âŒ Cancel reminders error: $e');
    }
  }
  ...
  Future<void> _checkBadges() async {
    try {
      ...
      print('âš ï¸ Badge check error: $e');
    }
  }
  ...
  void _celebrate() async {
    try {
      ...
      print('âš ï¸ Celebration error: $e');
    }
  }
  ...
  Future<void> _checkNotificationPermission() async {
    try {
      ...
      print('âš ï¸ Permission check error: $e');
    }
  }
                  ...
                  FutureBuilder<PermissionStatus>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text(
                        status.isGranted 
                          ? 'ðŸ”” Notifications: ON' 
                          : 'ðŸ”• Notifications: OFF (tap ðŸ”” icon to enable)',
                        style: TextStyle(
                          fontSize: 12,
...
class _CalendarHeatmapScreenState extends State<CalendarHeatmapScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      print('âŒ Calendar load error: $e');
      if (mounted) {
        setState(() => _loading = false);
      }
    }
